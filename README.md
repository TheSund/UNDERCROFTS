<img src="Assets/readme_materials/LOGO.png"/>
...
2. Before the run, you need to choose one of [REDACTED] playable characters, each with their own unique gameplay style!<br>
Although, we have ONLY one character ready... but you wait!
<img src="Assets/readme_materials/screen2.png"/>

3. After you choose the character, you are sent straight into the UNDERCROFTS!<br>
...
<img src="Assets/readme_materials/screen3.png"/>

4. And while doing so, you will have to FIGHT HORDES of spooky scary enemies!<br>
...
3. Когда определишся с персонажем, ты сразу отправляешься в ПОДЗЕМЕЛЬЯ!<br>
Прикол вот в чем - когда ты начинаешь новый забег, устройство уровней каждый раз будет совсем другим! Тебе придется вслепую исследовать лабиринт комнат, чтобы найти выход на следующий уровень!
<img src="Assets/readme_materials/screen3.png"/>

4. И пока ты гуляешь, тебе придется СРАЖАТЬСЯ с ОРДАМИ жутко страшных противников!<br>
...
5. Но если у тебя достаточно проблем со скиллом, то ты можешь даже ПОМЕРЕТЬ от них!<br>
